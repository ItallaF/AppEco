...
export default class JogodeUtensilioscomsuporteTerracota extends Component{
...
<View style={{flex:1, marginTop:Platform.OS =='ios'? 20 : 0, alignItems:'center'}}>
  <View style={styles.containerimg}>
    <Image source = {require('./Imagens/JogoUtensilios_Terracota_7405_Evo-Edit.jpg')} style ={styles.img}/>
        ...
        Jogo Utensilios Terracota</Text>
        <Text style={styles.prec}>R$15,11 </Text>
        <Text style={styles.descr}>
        produzido com materiais sustentáveis de alta qualidade. O jogo de Utensilios é composto por produtos que você mais utiliza em sua cozinha. Além de possuir o design clean e moderno, trazendo beleza e delicadeza para sua cozinha.</Text>
        <Text></Text>
        <TouchableOpacity
