...
export default class canudodeBambu extends Component{
...
<View style={{flex:1, marginTop:Platform.OS =='ios'? 20 : 0, alignItems:'center'}}>
  <View style={styles.containerimg}>
    <Image source = {require('./Imagens/canudo-de-bambu-canudo-ecologico.jpg')} style ={styles.img}/>
        ...
        <Text style={styles.prec}>R$8,70 </Text>
        <Text style={styles.descr}>
        Canudo biodegradável único e natural, fabricado com matéria-prima própria, e de forma artesanal.{"\n"}
         Altura: 1.00 cm{"\n"}
Largura: 1.00 cm{"\n"}
